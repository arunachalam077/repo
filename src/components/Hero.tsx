...
export const Hero = () => {
  return (
    ...
    <div className="container relative">
      ...
      <h1 className='text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex'>ZEYONE</h1>
      ...
      <p className='text-xl text-center mt-8 max-w-md'>Being the No.1 Digital Marketing Agency in Chennai!</p>
      </div>
      <div className="flex justify-center mt-8">
      <button className='bg-white text-black py-3 px-5 rounded-lg font-medium'>Expolre More</button>
      </div>
