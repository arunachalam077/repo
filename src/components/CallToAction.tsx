  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24" ref={containerRef}>
      ...
      <Image src={EmojiImage} alt="emoji" className="absolute -top-[120px] right-[calc(100%+30px)]" />
        ...
        <h2 className="font-bold text-5xl sm:text-6xl tracking-tighter">Get in Touch</h2>
        <p className="text-xl text-white/70  mt-5">Drive More Organic Traffic to Your Website
        and Strengthen Your Online Presence.</p>
        <form className="mt-10 flex flex-col gap-2.5 max-w-sm mx-auto sm:flex-row">
          <input type="email" placeholder="Arun@gmail.com" className="h-12 bg-white/20 rounded-lg px-5 font-medium placeholder:text-[#9CA3AF] sm:flex-1"/>
